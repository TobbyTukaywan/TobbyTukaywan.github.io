...
Welcome to my page. It's not very good, but hey, what are ya gonna do?
...
## Links
If you wanna look at a cool game I developed when I was 14, click [here](https://gamejolt.com/games/fnam/996455).\
If you're too lazy to scroll back up to the history section, click [here](#history-of-this-page)\
If you wanna read the README.md, click [here](README.md)
## Lists
Here's my favorite things about unordered lists:
- The pretty little dots
- Every item is equally important
- The other little shapes
  - like the unfilled dots
    - and the squares

Here's my favorite things about ordered lists:
1. Beautiful math
2. I can say that I like math more than saying that I can say that I like math more than saying that I can say that I...
3. Lowkey not a fan of those little shapes
    - They're kinda ugly, you know what I- Wait, what's going on
      - What's happening

Things left to do:
- [x] Create the index.md file
- [x] Fill it out
- [ ] (NOT OPTIONAL) Take a 4 hour break playing Warhammer 40,000: Darktide